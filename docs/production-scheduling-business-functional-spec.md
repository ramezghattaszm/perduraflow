...
| **Status** | Draft v0.10 |
| **Date** | 2026-06-10 |
| **Companion docs** | Platform architecture specification (Draft v0.8); Master Data module specification (Draft v0.3); Net-requirements module specification (Draft v0.3); Network material allocation module specification (Draft v0.2) |
...
| **D18** | Build-vs-configure of the optimization engine, and the specific optimization technique (CP/MILP/metaheuristic/APS), are deferred. | Implementation choice. | Open `→ Architecture doc` |
